...
public class RegistrationForm extends JFrame {
    ...
    private void saveData() {
        ...
        try {
            ...
            if (income < 0) {
                JOptionPane.showMessageDialog(this, "Monthly Income cannot be negative.", "Validation Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Monthly Income must be a valid number.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
