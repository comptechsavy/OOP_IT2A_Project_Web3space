...
public class MainMenu extends JFrame {
    ...
    // Variables to track open windows so we don't open duplicates
    ...
    public MainMenu() {
        ...
        // 1. Set Dark Blue Background
        headerPanel.setBackground(new Color(44, 62, 80)); 

        JLabel lblLogo = new JLabel();
        try {
            // Load logo from resources (works in JAR)
    ...
    private JButton createStyledButton(String text) {
        ...
        // Note: You can also add background colors here if you want buttons to match the Login buttons
