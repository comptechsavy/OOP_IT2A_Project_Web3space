...
public class LoginWindow extends JFrame {
    ...
    public LoginWindow() {
        ...
        JLabel lblLogo = new JLabel();
         try {
            // UPDATED LINE: Use getResource to find the image INSIDE the JAR
            ...
            e.printStackTrace(); // This helps you see errors if they happen
        }
    ...
    private void showRegisterDialog() {
        ...
        String[] roles = {"Barangay Secretary", "Clerk", "Admin"};
